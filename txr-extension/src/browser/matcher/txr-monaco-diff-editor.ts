...
export class MonacoDiffEditor extends MonacoEditor {
    // Note that the super constructor calls this.create, and this.create has been overwritten to set
    // _diffEditor.  An anti-pattern, for sure, but for time being just force typescript with !
    ...
    constructor(
        ...
        protected readonly diffNavigatorFactory: TxrMonacoDiffNavigatorFactory,
